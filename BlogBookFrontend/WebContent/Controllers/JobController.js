myApp.controller("JobController", function($scope, $http, $location, $rootScope, $cookieStore) {
	...
	$scope.addJob = function() {
		...
		$http.post('http://localhost:' + location.port + '/BlogBookMiddleware/addJob', $scope.job).then(function(response) {
	...
	$scope.showEditJob = function() {
		...
		$http.get('http://localhost:' + location.port + '/BlogBookMiddleware/getJob/' + editJobId).then(function(response) {
	...
	$scope.updateJob = function() {
		...
		$http.post('http://localhost:' + location.port + '/BlogBookMiddleware/updateJob', $scope.editJobInfo).then(function(response) {
	...
	$scope.getJobs = function() {
		...
		$http.get('http://localhost:' + location.port + '/BlogBookMiddleware/getJobList').then(function(response) {
		...
		$http.get('http://localhost:' + location.port + '/BlogBookMiddleware/getUserJobList/' + $rootScope.currentUser.username).then(function(response) {
	...
	$scope.openJob = function(jobId) {
		$http.get('http://localhost:' + location.port + '/BlogBookMiddleware/openJob/' + jobId).then(function(response) {
	...
	$scope.closeJob = function(jobId) {
		$http.get('http://localhost:' + location.port + '/BlogBookMiddleware/closeJob/' + jobId).then(function(response) {
	...
	$scope.deleteJob = function(jobId) {
		$http.get('http://localhost:' + location.port + '/BlogBookMiddleware/deleteJob/' + jobId).then(function(response) {
	...
	$scope.showJob = function(jobId) {
		if($location.path()!='/showJob'){
			...
			$http.get('http://localhost:' + location.port + '/BlogBookMiddleware/getJob/' + jobId).then(function(response) {
