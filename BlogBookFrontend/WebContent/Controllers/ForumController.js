myApp.controller("ForumController", function($scope, $http, $location, $rootScope, $cookieStore) {
	...
	if ($cookieStore.get("showForumId")) {
		// get existing Like
		$http.get('http://localhost:' + location.port + '/BlogBookMiddleware/getForumLike/' + $cookieStore.get("showForumId") + '/' + $rootScope.currentUser.username).then(function(response) {
			if (response.data) {
		...
		$http.get('http://localhost:' + location.port + '/BlogBookMiddleware/getForumDislike/' + $cookieStore.get("showForumId") + '/' + $rootScope.currentUser.username).then(function(response) {
			if (response.data) {
	...
	$scope.addForum = function() {
		...
		$http.post('http://localhost:' + location.port + '/BlogBookMiddleware/addForum', $scope.forum).then(function(response) {
	...
	$scope.showEditForum = function() {
		...
		$http.get('http://localhost:' + location.port + '/BlogBookMiddleware/getForum/' + editForumId).then(function(response) {
	...
	$scope.updateForum = function() {
		...
		$http.post('http://localhost:' + location.port + '/BlogBookMiddleware/updateForum', $scope.editForumInfo).then(function(response) {
	...
	$scope.getForums = function() {
		...
		$http.get('http://localhost:' + location.port + '/BlogBookMiddleware/getForumList').then(function(response) {
		...
		$http.get('http://localhost:' + location.port + '/BlogBookMiddleware/getUserForumList/' + $rootScope.currentUser.username).then(function(response) {
	...
	$scope.approveForum = function(forumId) {
		$http.get('http://localhost:' + location.port + '/BlogBookMiddleware/approveForum/' + forumId).then(function(response) {
	...
	$scope.rejectForum = function(forumId) {
		$http.get('http://localhost:' + location.port + '/BlogBookMiddleware/rejectForum/' + forumId).then(function(response) {
	...
	$scope.deleteForum = function(forumId) {
		$http.get('http://localhost:' + location.port + '/BlogBookMiddleware/deleteForum/' + forumId).then(function(response) {
	...
	$scope.showForum = function(forumId) {
		if($location.path()!='/showForum'){
			...
			$http.get('http://localhost:' + location.port + '/BlogBookMiddleware/getForum/' + forumId).then(function(response) {
	...
	$scope.likeClick = function() {
		...
		$http.get('http://localhost:' + location.port + '/BlogBookMiddleware/getForumLike/' + $cookieStore.get("showForumId") + '/' + $rootScope.currentUser.username).then(
				function(response) {
					...
					if (!existingLike) {
						...
						$http.post('http://localhost:' + location.port + '/BlogBookMiddleware/addForumLike', forumLike).then(function() {
						...
						$http.get('http://localhost:' + location.port + '/BlogBookMiddleware/incrementLike/' + $cookieStore.get("showForumId"));
						// check if there is an existing
						// dislike by user
						$http.get('http://localhost:' + location.port + '/BlogBookMiddleware/getForumDislike/' + $cookieStore.get("showForumId") + '/' + $rootScope.currentUser.username).then(
								function(response) {
									...
									if (existingDislike) {
										...
										// forum
										// dislike
										$http.get('http://localhost:' + location.port + '/BlogBookMiddleware/deleteForumDislike/' + existingDislike.forumDislikeId).then(function() {
										...
										// dislikes
										// value
										$http.get('http://localhost:' + location.port + '/BlogBookMiddleware/decrementDislike/' + $cookieStore.get("showForumId"));
									}
								});
					} else {
						// delete existing like
						$http.get('http://localhost:' + location.port + '/BlogBookMiddleware/deleteForumLike/' + existingLike.forumLikeId).then(function() {
							document.getElementById("forum-like-count").innerHTML = Number(document.getElementById("forum-like-count").innerHTML) - 1;
							console.log("Existing like removed.");
						});
						// decrement forum like value
						$http.get('http://localhost:' + location.port + '/BlogBookMiddleware/decrementLike/' + $cookieStore.get("showForumId"));
					}
				});
	};
	...
	$scope.dislikeClick = function() {
		...
		$http.get('http://localhost:' + location.port + '/BlogBookMiddleware/getForumDislike/' + $cookieStore.get("showForumId") + '/' + $rootScope.currentUser.username).then(function(response) {
			...
			if (!existingDislike) {
				...
				$http.post('http://localhost:' + location.port + '/BlogBookMiddleware/addForumDislike', forumDislike).then(function() {
					document.getElementById("forum-dislike-count").innerHTML = Number(document.getElementById("forum-dislike-count").innerHTML) + 1;
					console.log("Forum disliked.");
				});
				// increment forum dislike value
				$http.get('http://localhost:' + location.port + '/BlogBookMiddleware/incrementDislike/' + $cookieStore.get("showForumId"));
				// check if there is an existing
				// like by user
				$http.get('http://localhost:' + location.port + '/BlogBookMiddleware/getForumLike/' + $cookieStore.get("showForumId") + '/' + $rootScope.currentUser.username).then(function(response) {
					var existingLike = response.data;
